...
class Algorithm {
	...
	public static void buildMatrix(char [][]arr,char [] s,int row,int col,int length){
if(length <=2) {
	...
	copyMatrix(arr, row, col, row+length/2, col+length/2, length/2);
	copyMatrix(arr, row+length/2, col, row, col+length/2, length/2);
}
}

public static void copyMatrix(char [][]arr,int i1,int j1,int i2,int j2,int length) {
